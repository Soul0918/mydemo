...
class AdminbaseController extends AppframeController {
    ...
    protected $app_menu = array('Admin','Api','Asset','Comment','Common','Company','Demo','Install','Portal','User','Wechat');
    ...
    private function check_access($uid){
        ...
        $rule=$module_controller.ACTION_NAME;
        
        $no_need_check_rules=array("AdminIndexindex","AdminMainindex");
        $no_need_check_other_rules = [
        		$module_controller.'table_data', 
        		$module_controller.'getRoles',
        		$module_controller.'getCommunities',
        ];
        $no_need_check_rules = array_merge($no_need_check_rules, $no_need_check_other_rules);
