...
namespace Think\Upload\Driver\Cos\qcloudcos;
...
class Auth {
    ...
    public static function createReusableSignature($expiration, $bucket, $filepath = null) {
        $appId = C('UPLOAD_TYPE_CONFIG')['appid'];
        $secretId = C('UPLOAD_TYPE_CONFIG')['secretID'];
        $secretKey = C('UPLOAD_TYPE_CONFIG')['secretKey'];
