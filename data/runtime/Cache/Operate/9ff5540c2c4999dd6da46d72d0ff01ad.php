...
<div id="divMenu" class="layui-side layui-bg-black" style="top:60px;">
    ...
    <button class="layui-btn layui-btn-normal layui-btn-small" onclick="showDetailForm();"><?php echo L('ADMIN_USER_ADD');?></button>
    <div class="layui-form search-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline search-input">
                <input class="layui-input"  autocomplete="off" placeholder="用户名/昵称/邮箱" value="<?php echo I('request.keyword');?>" type="text" name="search" id="txtSearch">
    ...
    <table class="table table-bordered" id="tabList" data-page-list="[10,20,50]">
        <thead>
            <tr>
                <th data-field="control" data-formatter="controlFormatter" data-width="50" data-align="center"><?php echo L('ACTIONS');?></th>
                <th data-field="user_name" data-sortable="true" data-width="100"><?php echo L('USERCOMPANY_NAME');?></th>
                <th data-field="mobile" data-sortable="true" data-width="120"><?php echo L('USERCOMPANY_PHONE');?></th>
                <!-- 			<th data-field="user_activation_key" data-formatter="actFormatter" data-sortable="true" data-width="120">邀请码</th> -->
                <th data-field="last_login_time" data-formatter="last_login_timeFormatter" data-sortable="true" data-width="160"><?php echo L('USERCOMPANY_LAST_LOGIN_TIME');?></th>
                <th data-field="user_email" data-sortable="true" data-width="100"><?php echo L('USERCOMPANY_EMAIL');?></th>
        <?php if($genre > 0): ?><th data-field="company_name"  data-width="100">所属物业公司</th><?php endif; ?>
        <?php if($genre == 2): ?><th data-field="community_name"   data-width="100">所属小区</th><?php endif; ?>
        <th data-field="user_status" data-formatter="statusFormatter" data-sortable="true" data-width="60"><?php echo L('STATUS');?></th>
        </tr>
        </thead>
    </table>
    ...
    <script>
        ...
        function load(objParam) {
            $('#tabList')
                    .bootstrapTable(
                            {
                                method: 'get',
                                url: "<?php echo U('table_data', array('genre'=>$genre));?>",
                                ...
                                onDblClickRow: function (row, e, field) {
                                    ...
                                    if (field != 'control') {
                                        showDetail("<?php echo U('edit');?>?id=" + row.id);
                                    }
                                }
                            });
        }
        ...
        function showDetailForm() {
            showDetail("<?php echo U('add',array('genre'=>$genre));?>");
        }

        function showDetailEdit(id, _) {
            showDetail("<?php echo U('edit',['edit'=>$canEdit]);?>?id=" + id + "&genre=<?php echo ($genre); ?>" + _)
        }
