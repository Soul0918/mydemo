...
<div id="divMenu" class="layui-side layui-bg-black" style="top:60px;">
    ...
    <div class="layui-btn layui-btn-normal layui-btn-small" onclick="add()"><?php echo L("ADD");?></div>
    ...
    <div class="layui-form search-form">
        <div class="layui-form-item">
            <div class="layui-input-inline search-input">
                <input class="layui-input"  autocomplete="off" placeholder="收据编号/客户名称" value="<?php echo I('request.search');?>" type="text" name="search" id="txtSearch">
    ...
    <table class="table table-hover table-bordered"
        ...
        <thead>
            <tr>
                <th data-field="control" data-formatter="actionFormatter" data-align="center" data-width="100"><?php echo L('ACTIONS');?></th>
    ...
    <script src="/demo-master/public/bootstrap-table-master/src/extensions/table-export/tableExport.js"></script>
    <script>
            ...
            if ($('#tabList').bootstrapTable('getData').length > 0) {
                ...
                layer.msg('请先查询数据！', {
                    ...
                    function actionFormatter(value, row) {
                        var action = [];
                        action.push('<a onclick="showDetail(\'<?php echo U('edit');?>?id=' + row.lifestyle_id + '\')" class="table_btn" ><?php echo L('DETAIL');?></a>');
                        action.push('<a  class="table_btn" href="<?php echo U('detail');?>?id=' + row.lifestyle_id + '\">打印预览</a>');
                        return action;
                    }
