...
<div id="divMenu" class="layui-side layui-bg-black" style="top:60px;">
    ...
    <button class="layui-btn layui-btn-normal layui-btn-small" type="submit" id="btn" lay-filter="*" lay-submit=""><?php echo L('SAVE');?></button>
	...
	<form id="form">
        ...
        <fieldset>
            <div class="layui-form-item">
                <label class="layui-form-label" ><?php echo L('OLD_PASSWORD');?></label>
                <div class="layui-input-inline">
                    <input type="password" name="old_password" required lay-verify="required"  placeholder="<?php echo L('OLD_PASSWORD');?>" autocomplete="off" id="oldpassword" class="layui-input">
                </div>                        
...
<span group="edit" class="form-required" style="color: red;">*</span>
            ...
            <div class="layui-form-item">
                <label class="layui-form-label"><?php echo L('NEW_PASSWORD');?></label>
                <div class="layui-input-inline">
                    <input type="password" name="password" required lay-verify="required" placeholder="<?php echo L('NEW_PASSWORD');?>" autocomplete="off" id="newpassword" class="layui-input">
                </div>                        
...
<span group="edit" class="form-required" style="color: red;">*</span>
            ...
            <div class="layui-form-item">
                <label class="layui-form-label"><?php echo L('CONFIRM_PASSWORD');?></label>
                <div class="layui-input-inline">
                    <input type="password" name="repassword" required lay-verify="required" placeholder="<?php echo L('CONFIRM_PASSWORD');?>" autocomplete="off" id="repassword"  class="layui-input">
                </div>
<span group="edit" class="form-required" style="color: red;">*</span>
                <div class="layui-form-mid layui-word-aux" style="display: none" id="rp"><?php echo L('PLEASE_CONFIRM_PASSWORD');?></div>
                <div class="layui-form-mid layui-word-aux" style="display: none" id="dp"><?php echo L('ERROR_PASSWORD');?></div>
            </div>
	...
	<script>
	var link_url = "<?php echo U('password_post');?>";
	</script>
<!-- 	<script src="/demo-master/public/js/formsubmit.js"></script> -->
    <script>
        var b = "";
        var c = "";
